...
img.paste(status_img, box=(20, 35))
...
font = ImageFont.truetype(os.path.join(fontpath, "x14y24pxHeadUpDaisy.ttf"), 28)
draw.text((20, 86), temp_max, 2, font=font)
draw.text((20, 86), "   /%s" % temp_min, 0, font=font)

font2 = ImageFont.truetype(os.path.join(fontpath, "vlgothic/VL-Gothic-Regular.ttf"), 12)
draw.text((120, 0), data_from, 0, font=font2)

font3 = ImageFont.truetype(os.path.join(fontpath, "x8y12pxTheStrongGamer.ttf"), 12)
draw.text((120, 10), forecast_date, 0, font=font3)
